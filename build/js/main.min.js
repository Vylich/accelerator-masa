...
var createNews = function createNews() {
  ...
  var breakpointChecker = function breakpointChecker() {
    switch (true) {
      case breakpointDesktop.matches:
        ...
        _dataNews.newsData.forEach(function (elem, index) {
      ...
      case breakpointTablet.matches:
        newsSliderWrapperNode.innerHTML = '';
        var newsDataChunked = chunkArray(_dataNews.newsData, 4);
      ...
      case breakpointMobile.matches:
        newsDataChunked = chunkArray(_dataNews.newsData, 2);
        newsDataChunked.forEach(function (item) {
          var element = document.createElement('div');
          element.classList.add('slide-grid');
          element.classList.add('swiper-slide');
...
},{"../data-news/data-news":1}],13:[function(require,module,exports){
"use strict";
...
exports.initReviewsSlider = exports.initProgramsSlider = exports.initNewsSlider = exports.initHeroSlider = void 0;
