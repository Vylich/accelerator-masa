...
var newsData = [{
  ...
  text: "\u0421\u0430\u0448\u0430 \u0440\u0430\u0441\u0441\u043A\u0430\u0437\u044B\u0432\u0430\u0435\u0442, \u043A\u0430\u043A \u043F\u043E\u043F\u0430\u043B\u0430 \u0432\xA0\u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0443 \u0438\xA0\u043A\u0430\u043A \u043F\u0440\u043E\u0448\u043B\u0430 6-\u043C\u0435\u0441\u044F\u0447\u043D\u0430\u044F \u0441\u0442\u0430\u0436\u0438\u0440\u043E\u0432\u043A\u0430 \u0432\xA0ISOFound"
}, {
  type: 'trips',
  ...
  title: 'Интервью с участницей программы стажировки',
  webp: 'img/news/news-interview.webp 1x, img/news/news-interview@2x.webp 2x',
  text: "\u0421\u0430\u0448\u0430 \u0440\u0430\u0441\u0441\u043A\u0430\u0437\u044B\u0432\u0430\u0435\u0442, \u043A\u0430\u043A \u043F\u043E\u043F\u0430\u043B\u0430 \u0432\xA0\u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0443 \u0438 \u043A\u0430\u043A \u043F\u0440\u043E\u0448\u043B\u0430 6-\u043C\u0435\u0441\u044F\u0447\u043D\u0430\u044F \u0441\u0442\u0430\u0436\u0438\u0440\u043E\u0432\u043A\u0430 \u0432 ISOFound"
}, {
  type: 'interview',
  src: 'img/news/news-interview.jpg',
  srcset: 'img/news/news-interview@2x.jpg 2x',
...
var _initNews = require("./modules/init-news");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _map.createMap)();
  (0, _slider.initProgramsSlider)();
  (0, _dropdown.initDropdown)();
  (0, _slider.initReviewsSlider)();
  (0, _accordion.showContentAccordion)();
  (0, _initNews.initNewsSlider)();
  (0, _menu.initMenu)();
...
},{"./modules/accordion":3,"./modules/dropdown":4,"./modules/form-validate/form":6,"./modules/init-news":12,"./modules/map":13,"./modules/menu":14,"./modules/modals/init-modals":15,"./modules/slider":17,"./utils/ios-vh-fix":20}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showContentAccordion = void 0;
var items = document.querySelectorAll('.accordion__item');
var showContentAccordion = function showContentAccordion() {
  items.forEach(function (item) {
    var headers = item.querySelectorAll('.accordion__header');
    headers.forEach(function (header) {
      header.insertAdjacentHTML('beforeEnd', '<button></button>');
      header.addEventListener('click', function () {
        header.blur();
        var activeContent = document.querySelector('#' + header.dataset.acc);
...
var dropDownBtn = dropDownWrapper.querySelector('.dropdown__btn');
var dropDownList = dropDownWrapper.querySelector('.dropdown__list');
var dropDownListItems = dropDownList.querySelectorAll('.dropdown__item');
var dropdownSelect = document.querySelector('.form__sity-select');
var dropdownText = dropDownWrapper.querySelector('.dropdown__text');
...
exports.initNewsSlider = exports.createNews = void 0;
var _dataNews = require("../data-news/data-news");
...
var newsSliderWrapperNode = document.querySelector('.news__container');
var sliderNews = document.querySelector('.news__slider');
var newTabsNode = document.querySelectorAll('.news__btn');
var initNewsSlider = function initNewsSlider() {
  createNews(_dataNews.newsData);
  ...
  newTabsNode.forEach(function (btn) {
    return btn.addEventListener('click', function () {
      newTabsNode.forEach(function (el) {
      ...
      if (filter === 'all') {
        ...
        var newNews = _dataNews.newsData.filter(function (el) {
...
},{"../data-news/data-news":1,"../vendor/swiper":23}],13:[function(require,module,exports){
"use strict";
...
},{"../vendor/leaflet":22}],14:[function(require,module,exports){
"use strict";
...
var btnMenuNode = document.querySelector('.header__button');
var btnMenu = btnMenuNode.querySelector('button');
var menuNode = document.querySelector('.menu');
var bodyNode = document.querySelector('body');
var headerMenuNode = document.querySelector('.header__menu');
var menuSelects = document.querySelectorAll('.item-select__wrapper');
var initMenu = function initMenu() {
  ...
  menuSelects.forEach(function (select) {
    select.addEventListener('click', function () {
      var activeContent = document.querySelector('#' + select.dataset.menu);
      if (activeContent.classList.contains('is-active')) {
        activeContent.classList.remove('is-active');
...
var closeMenu = function closeMenu() {
  ...
  var overlay = headerMenuNode.querySelector('.overlay');
...
exports.initReviewsSlider = exports.initProgramsSlider = exports.initHeroSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper.js"));
var _initNews = require("./init-news.js");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var heroSliderNode = document.querySelector('.hero');
var programsSliderNode = document.querySelector('.programs__slider');
var initHeroSlider = function initHeroSlider() {
  var swiperTouchStartX;
  new _swiper.default(heroSliderNode, {
    speed: 300,
    effect: 'fade',
    fadeEffect: {
      crossFade: false
...
var lineChild = document.querySelector('.programs__inner-line');
var lineParent = document.querySelector('.programs__line');
var slides = document.querySelectorAll('.programs__card');
var initProgramsSlider = function initProgramsSlider() {
  ...
  var width = lineParent.offsetWidth / (slides.length - widthCount);
  var currentWidth = width;
  lineChild.style.width = "".concat(currentWidth, "px");
  var swiper = new _swiper.default(programsSliderNode, {
    speed: 300,
    slidesPerView: 'auto',
    spaceBetween: 0,
    navigation: {
...
var slidesReviews = document.querySelectorAll('.reviews__item');
var lineParentReviews = document.querySelector('.reviews__line');
var lineChildReviews = document.querySelector('.reviews__inner-line');
var initReviewsSlider = function initReviewsSlider() {
  ...
  var width = lineParentReviews.offsetWidth / (slidesReviews.length - widthCount);
  var currentWidth = width;
  lineChildReviews.style.width = "".concat(currentWidth, "px");
  var swiper = new _swiper.default(sliderReviews, {
    speed: 300,
    spaceBetween: 30,
    slidesPerView: 'auto',
    navigation: {
...
},{"../vendor/swiper.js":23,"./init-news.js":12}],18:[function(require,module,exports){
"use strict";
